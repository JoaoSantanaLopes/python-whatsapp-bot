...
# CONFIGURAÇÕES
# -------------------------------
VERIFY_TOKEN = "joaovitorsantanalopes"
ACCESS_TOKEN = ""
        ...
        for entry in data.get("entry", []):
            for change in entry.get("changes", []):
                ...
                for message in messages:
                    ...
                    print(f"Mensagem recebida de {phone}: {text}")  # Aqui aparece o seu "Oi" no terminal
...
if __name__ == "__main__":
    ...
    # Envie hello world manualmente para você mesmo
